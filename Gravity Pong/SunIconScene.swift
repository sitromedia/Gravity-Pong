...
class SunIconScene: SKScene {
    ...
    override init(size: CGSize) {
        ...
        var message1 = "STARS"
        var message2 = "Avoid these at all costs. "
        var message3 = "If you hit one, you will explode. "
        
        let sun = SKSpriteNode(imageNamed: "sun")
        sun.size = CGSize(width: 100, height: 100)
        sun.position = CGPoint(x: -80, y: 90)
        
        let sunOne = SKSpriteNode(imageNamed: "sun_one")
        sunOne.size = CGSize(width: 100, height: 100)
        sunOne.position = CGPoint(x: -40, y: 90)
        
        let sunTwo = SKSpriteNode(imageNamed: "sun_two")
        sunTwo.size = CGSize(width: 100, height: 100)
        sunTwo.position = CGPoint(x: 40, y: 90)
        
        let sunThree = SKSpriteNode(imageNamed: "sun_three")
        sunThree.size = CGSize(width: 100, height: 100)
        sunThree.position = CGPoint(x: 80, y: 90)
